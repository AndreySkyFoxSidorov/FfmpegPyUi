...
WORKFLOW_OPTIONS = {
    "output_container": [
        ...
        {"value": "mkv", "label_key": "option.output_container.mkv"},
        {"value": "webm", "label_key": "option.output_container.webm"},
        {"value": "mp3", "label_key": "option.output_container.mp3"},
        {"value": "wav", "label_key": "option.output_container.wav"},
        {"value": "aac", "label_key": "option.output_container.aac"},
        {"value": "flac", "label_key": "option.output_container.flac"},
    ...
    "gif_dither": [
        ...
        {"value": "none", "label_key": "option.gif_dither.none"},
    ],
    "resolution_mode": [
    ...
    "video_codec": [
        ...
        {"value": "libaom-av1", "label_key": "option.video_codec.libaom-av1"},
    ...
    "video_filter": [
        {"value": "none", "label_key": "option.video_filter.none"},
        {"value": "hflip", "label_key": "option.video_filter.hflip"},
        {"value": "vflip", "label_key": "option.video_filter.vflip"},
        {"value": "rotate_90", "label_key": "option.video_filter.rotate_90"},
        {"value": "grayscale", "label_key": "option.video_filter.grayscale"},
        {"value": "eq", "label_key": "option.video_filter.eq"},
        {"value": "denoise", "label_key": "option.video_filter.denoise"},
        {"value": "sharpen", "label_key": "option.video_filter.sharpen"},
        {"value": "deinterlace", "label_key": "option.video_filter.deinterlace"},
        {"value": "pad_square", "label_key": "option.video_filter.pad_square"},
        {"value": "drawtext", "label_key": "option.video_filter.drawtext"},
    ],
    "audio_filter": [
        {"value": "none", "label_key": "option.audio_filter.none"},
        {"value": "loudnorm", "label_key": "option.audio_filter.loudnorm"},
        {"value": "highpass", "label_key": "option.audio_filter.highpass"},
        {"value": "lowpass", "label_key": "option.audio_filter.lowpass"},
        {"value": "acompressor", "label_key": "option.audio_filter.acompressor"},
        {"value": "afade", "label_key": "option.audio_filter.afade"},
        {"value": "silenceremove", "label_key": "option.audio_filter.silenceremove"},
    ],
}
...
WORKFLOW_SECTIONS = [
        ...
        "fields": [
            {
                ...
                "type": "entry",
                "value_type": "int",
                "label_key": "field.gif_width.label",
                "description_key": "field.gif_width.description",
            },
            {
                "key": "gif_fps",
                "type": "entry",
                "value_type": "int",
                "label_key": "field.gif_fps.label",
                "description_key": "field.gif_fps.description",
            },
            {
                "key": "gif_dither",
                "type": "choice",
                "options": "gif_dither",
                "label_key": "field.gif_dither.label",
                "description_key": "field.gif_dither.description",
            },
        ],
    },
    {
    ...
    {
        "title_key": "section.video_filters.title",
        "description_key": "section.video_filters.description",
        "fields": [
            {
                "key": "video_filter_1",
                "type": "choice",
                "options": "video_filter",
                "label_key": "field.video_filter_1.label",
                "description_key": "field.video_filter_1.description",
            },
            {
                "key": "video_filter_2",
                "type": "choice",
                "options": "video_filter",
                "label_key": "field.video_filter_2.label",
                "description_key": "field.video_filter_2.description",
            },
            {
                "key": "video_filter_3",
                "type": "choice",
                "options": "video_filter",
                "label_key": "field.video_filter_3.label",
                "description_key": "field.video_filter_3.description",
            },
            {
                "key": "video_eq_brightness",
                "type": "slider",
                "min": -1.0,
                "max": 1.0,
                "steps": 40,
                "label_key": "field.video_eq_brightness.label",
                "description_key": "field.video_eq_brightness.description",
            },
            {
                "key": "video_eq_contrast",
                "type": "slider",
                "min": 0.0,
                "max": 3.0,
                "steps": 30,
                "label_key": "field.video_eq_contrast.label",
                "description_key": "field.video_eq_contrast.description",
            },
            {
                "key": "video_eq_saturation",
                "type": "slider",
                "min": 0.0,
                "max": 3.0,
                "steps": 30,
                "label_key": "field.video_eq_saturation.label",
                "description_key": "field.video_eq_saturation.description",
            },
            {
                "key": "video_denoise_strength",
                "type": "slider",
                "min": 0.0,
                "max": 10.0,
                "steps": 20,
                "label_key": "field.video_denoise_strength.label",
                "description_key": "field.video_denoise_strength.description",
            },
            {
                "key": "video_sharpen_strength",
                "type": "slider",
                "min": 0.0,
                "max": 5.0,
                "steps": 20,
                "label_key": "field.video_sharpen_strength.label",
                "description_key": "field.video_sharpen_strength.description",
            },
            {
                "key": "video_text",
                "type": "entry",
                "value_type": "text",
                "label_key": "field.video_text.label",
                "description_key": "field.video_text.description",
            },
            {
                "key": "advanced_video_filters",
                "type": "entry",
                "value_type": "text",
                "label_key": "field.advanced_video_filters.label",
                "description_key": "field.advanced_video_filters.description",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "label_key": "field.audio_filter_1.label",
                "description_key": "field.audio_filter_1.description",
            },
            {
                "key": "audio_filter_2",
                "type": "choice",
                "options": "audio_filter",
                "label_key": "field.audio_filter_2.label",
                "description_key": "field.audio_filter_2.description",
            },
            {
                "key": "audio_filter_3",
                "type": "choice",
                "options": "audio_filter",
                "label_key": "field.audio_filter_3.label",
                "description_key": "field.audio_filter_3.description",
            },
            {
                "key": "audio_highpass_hz",
                "type": "entry",
                "value_type": "int",
                "label_key": "field.audio_highpass_hz.label",
                "description_key": "field.audio_highpass_hz.description",
            },
            {
                "key": "audio_lowpass_hz",
                "type": "entry",
                "value_type": "int",
                "label_key": "field.audio_lowpass_hz.label",
                "description_key": "field.audio_lowpass_hz.description",
            },
            {
                "key": "audio_fade_seconds",
                "type": "entry",
                "value_type": "float",
                "label_key": "field.audio_fade_seconds.label",
                "description_key": "field.audio_fade_seconds.description",
            },
            {
                "key": "advanced_audio_filters",
                "type": "entry",
                "value_type": "text",
                "label_key": "field.advanced_audio_filters.label",
                "description_key": "field.advanced_audio_filters.description",
            },
        ],
    },
]
